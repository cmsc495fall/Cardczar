<!-- This PHP file is for passing winner number from the database to the app -->
...
// GET gamestate winner (int) FROM DATABASE AND ECHO TO APP
$query = "SELECT winner FROM gamestate LIMIT 1";
